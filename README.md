...
城市规划师经常需要外出实地调研，大多数情况都是用两步路来记录地点，但两步路作为城市规划实地调研照片收集是在不好用。因此我希望做一个直接通过手机拍的照片来做照片整理，这些照片的 EXIF 里自带 GPS 坐标，但回到电脑上只能在文件夹里干看。GeoSetter 这类工具又没有国内地图源，地图加载极慢。而且现在AI实景生图在城市更新领域越来越常用，下一步计划将增加实景改造效果的对比，对进行改造的地点增加对比展示，
